...
def main():
    ...
    grid_search = GridSearchCV(clf, param_grid, \
                               ...
                               n_jobs=10, pre_dispatch='2*n_jobs', iid=False,\
                               cv=10, refit=True, verbose=0, \
    ...
    print(f"Score:\n{score}")
    # export to .csv
    weight_df = pd.DataFrame(grid_search.best_estimator_.coef_)
