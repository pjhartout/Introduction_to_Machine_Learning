...
def main():
    ...
    RMSE_df.to_csv(FLAGS.RMSE, sep=" ", index=False, header=False, float_format='%.2f')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--RMSE", type=str, required=True,
                        help="path where the CSV file for RMSE should be written")
